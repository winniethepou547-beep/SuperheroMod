...
import com.FIRNI.superheromod.heroes.cyclops.CyclopsCharacter;
...
public class SuperheroMod
{
    ...
    public SuperheroMod(FMLJavaModLoadingContext context)
    {
        ...
        // RegisterCapabilitiesEvent MOD event bus'ta atesleniyor, otomatik taranmiyor - elle bagliyoruz
        modEventBus.addListener(ProgressionEvents::onRegisterCapabilities);
