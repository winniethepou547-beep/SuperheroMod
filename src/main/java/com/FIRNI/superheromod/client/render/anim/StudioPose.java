...
public final class StudioPose {
    ...
    /** Satir formatindaki deger sayisi: sure + 6 parca * 3 eksen + dirsek. */
    public static final int ROW_SIZE = 1 + PARTS * 3 + 1;
    ...
    /** Iki poz arasi yumusak gecis; sonuc {@code out}'a yazilir. */
    ...
    /** Kaydetme/disa aktarma icin duz satir: [sure, ...donusler, dirsek]. */
